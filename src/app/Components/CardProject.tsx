...
export default function CardProject({ project, children }: CardProjectProps) {
    return (
        <div className="w-full max-w-lg rounded-lg overflow-hidden shadow-lg bg-white/5 
        backdrop-blur-md border border-white/10 hover:shadow-xl transition-all duration-300 
        h-[350px]">
            <div className="relative w-full h-[150px] aspect-video overflow-hidden bg-white/5">
                <Image
                    src={project.image}
                    alt={project.title}
                    fill
